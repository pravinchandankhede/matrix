...
internal class CustomAgentApp : AgentApp
{
    public CustomAgentApp(String agentName, String agentType)
    ...
    public override AgentResponse GetChatResponseAsync(AgentRequest request)
    {
        ...
        return new AgentResponse { Response = $"[Custom] {request.Query}", IsComplete = true };
    }
}