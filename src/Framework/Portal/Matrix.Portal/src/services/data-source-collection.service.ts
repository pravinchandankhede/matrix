...
export class DataSourceCollectionService {
    ...
    updateDataSourceCollection(id: string, DataSourceCollection: DataSourceCollection): Observable<DataSourceCollection> {
        return this.http.put<DataSourceCollection>(`${this.apiUrl}/${id}`, DataSourceCollection);
    }
